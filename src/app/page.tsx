      ...
      <section className="py-20 bg-secondary-100">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {/* Step cards with yellow accents */}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="text-center p-6 bg-secondary-50 rounded-xl hover:bg-secondary-100 transition-colors">
                <div className="text-secondary-500 mb-4 flex justify-center">{feature.icon}</div>
                <h3 className="text-lg font-semibold mb-2 text-secondary-800">{feature.title}</h3>
                <p className="text-secondary-700 text-sm">{feature.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 bg-secondary-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <div className="bg-secondary-500/20 backdrop-blur-sm rounded-lg p-4">
