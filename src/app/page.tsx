  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4 text-gray-900">Cara Kerja Platform</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              <div className="w-16 h-16 qomarun-bg-green rounded-full flex items-center justify-center mx-auto mb-6">
                <span className="text-white text-2xl font-bold">1</span>
              </div>
              <h3 className="text-xl font-semibold mb-3 text-gray-900">Buat Laporan</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900">Dapatkan Nomor Tiket</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900">Pantau Progress</h3>
              <p className="text-gray-600">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4 text-gray-900">Mengapa Memilih Qomarun?</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="text-center p-6 bg-green-50 rounded-xl hover:bg-green-100 transition-colors">
                <div className="qomarun-green mb-4 flex justify-center">{feature.icon}</div>
      ...
      <section className="py-16 qomarun-bg-green text-white">
